...
var budgetController = (function () {
  ...
  return {
    // this object returns all the public methods

    addItem: function (type, des, val) {
      var newItem, ID;

      //[1 2 3 4 5], next ID = 6
      //but if we delete some things, [1 2 4 6 8], next ID = 9
      // ID = last ID + 1

      // 1. Create new ID
      if (data.allItems[type].length > 0) {
        // data.allItems[type][data.allItems[type].length - 1].id and then + 1 for the id of newItem
    ...
    calculateBudget: function () {
      ...
      // Calculate the budget: income - expenses // (income & expenses are stored in the global data structure)
...
var UIController = (function () {
  ...
  return {
    ...
    addListItem: function (obj, type) {
      ...
      // 2. Replace the placeholder text with some actual data which is the data that receive from the object
